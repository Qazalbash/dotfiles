...
(doom! :input
       ...
       (corfu +orderlesscons +dabbrev)  ; complete with cap(f), cape and a flying feather!
       ...
       (markdown +treesitter)          ; writing docs for people to ignore
       ...
       (python +uv +lsp +treesitter)            ; beautiful is better than ugly
